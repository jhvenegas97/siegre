@section('title', 'Administrador Niveles Académicos')
...
@section('content')
    ...
    @endif
     ...
     <div class="container-fluid">
        <center>
            <h3 class="mb-4">Lista de Niveles Académicos</h3>
        </center>
        <div class="row d-flex justify-content-start flex-column flex-md-row">
            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start mb-4">
                ...
                <div class="col-12 d-flex justify-content-center justify-content-md-start">
                    <button id="addNewAcademicLevel" class="btn btn-primary btn-new" data-bs-toggle="modal" data-bs-target="#facultyCreate">Crear Nivel Académico</button>
                </div>
                @endcan
            </div>
     ...
     <div class="modal" id="ajax-academic-level-model" tabindex="-1" aria-hidden="true">
                 ...
                 <div class="modal-body">
                     <div class="row d-flex justify-content-center">
                         <div class="col-12  d-flex justify-content-center">
                             <h5 class="modal-title" id="ajaxAcademicLevelModel">Crear Nivel Académico</h5>
                         </div>
                     </div>

                     <div class="d-grid gap-2 ps-4 pe-4 mt-2">
                         <form method="POST" action="javascript:void(0)" id="addEditAcademicLevelForm" name="addEditAcademicLevelForm">
                             @csrf
                             <input type="hidden" name="id" id="id">
                             <div class="mb-3">
                                 <input id="name_academicLevelID" type="text" class="form-control" name="name_academic_level" value="" required autocomplete="name_academic_level" autofocus placeholder="Nombre del Nivel Académico">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#addNewAcademicLevel').click(function (e) {
                e.preventDefault();
                cleanErrors();
            ...
            $('body').on('click', '#btn-save', function (e) {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if ($("#ajaxAcademicLevelModel").text() == "Editar Nivel Académico") {
                            Toast.fire({
                                icon: 'success',
