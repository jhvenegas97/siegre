@section('title', 'Administrador Usuarios Trabajando')
...
@section('content')
    ...
    @endif
     ...
     <div class="container-fluid">
        <center>
            <h3 class="mb-4">Reporte de Usuarios Trabajando</h3>
        </center>
        <div class="row d-flex justify-content-start flex-column flex-md-row">
            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start mb-4">
                ...
                <a class="ms-2" href="{{ route('working-user.excel') }}"><button id="exportExcel" class="btn btn-primary btn-new">Exportar a Excel</button></a>
                </div>
            </div>
        </div>
