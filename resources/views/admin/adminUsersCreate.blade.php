                                ...
                                <div class="col-md-8 col-lg-6 col-xl-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body me-2 ms-2">
                                            <form id="userData" method="POST" action="{{ route('store-admin') }}" enctype="multipart/form-data" onSubmit="return false;">
                                                <div class="d-flex justify-content-end">
                                                    <div class="form-group form-check">
                                                        {{ Form::checkbox('showCurriculum',true, array('class' => 'form-check-input')) }}
                                                ...
                                                <div class="row mb-3 flex-column">
                                                    ...
                                                    <div class="col-12">
                                                        <input id="description" type="text" class="form-control" name="description" value="" autocomplete="description" autofocus>
                                                ...
                                                <div class="row mb-3 flex-column">
                                                    ...
                                                    <div class="col-12">
                                                        <input id="phone" type="text" class="form-control" name="phone" value="" autocomplete="phone" autofocus>
                                                ...
                                                <div class="row mb-3 flex-column">
                                                    ...
                                                    <div class="col-12">
                                                        <input id="identification_id" type="text" class="form-control" name="identification_id" value="" required autocomplete="new-identification-id">
