@section('title', 'Administrador Títulos Académicos Usuario')
...
@section('content')
    ...
    @endif
     ...
     <div class="container-fluid">
        <center>
            <h3 class="mb-4">Reporte de Títulos Académicos por Usuario</h3>
        </center>
        <div class="row d-flex justify-content-start flex-column flex-md-row">
            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start mb-4">
                ...
                <a class="ms-2" href="{{ route('college-degree-user.excel') }}"><button id="exportExcel" class="btn btn-primary btn-new">Exportar a Excel</button></a>
                </div>
            </div>
        </div>
         ...
         <div class="table-responsive">
             <table class="table table-striped" style="width:100%" id="datatable-ajax-crud">
                 ...
                 <tr>
                     ...
                     <th scope="col" class="align-middle text-center">Título Académico</th>
                     <th scope="col" class="align-middle text-center">Nivel Académico</th>
                 </tr>
                 </thead>
             </table>
         </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#datatable-ajax-crud').DataTable({
                                processing: true,
                serverSide: true,
                ajax: "{{ url('reports-college-degree-user') }}",
                columns: [
                    { data: 'identification_id', name: 'identification_id' },
                    { data: 'name', name: 'name' },
                    { data: 'email', name: 'email' },
                    { data: 'title_academic', name: 'title_academic' },
