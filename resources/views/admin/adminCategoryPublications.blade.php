@section('title', 'Administrador Categorías de Publicaciones')
...
@section('content')
    ...
    @endif
     ...
     <div class="container-fluid">
        <center>
            <h3 class="mb-4">Lista de Categoría de Publicaciones</h3>
        </center>
     ...
     <div class="modal" id="ajax-category-publication-model" tabindex="-1" aria-hidden="true">
                 ...
                 <div class="modal-body">
                     <div class="row d-flex justify-content-center">
                         <div class="col-12  d-flex justify-content-center">
                             <h5 class="modal-title" id="ajaxCategoryPublicationModel">Crear Categoría de Publicación</h5>
                         </div>
                     </div>

                     <div class="d-grid gap-2 ps-4 pe-4 mt-2">
                         <form method="POST" action="javascript:void(0)" id="addEditCategoryPublicationForm" name="addEditCategoryPublicationForm">
                             @csrf
                             <input type="hidden" name="id" id="id">
                             <div class="mb-3">
                                 <input id="name_category_publicationID" type="text" class="form-control" name="name_category_publication" value="" required autocomplete="name_category_publication" autofocus placeholder="Nombre de la Categoría">
                                     ...
                                     <div class="d-grid gap-2 m-2">
                                         <a href="" style="text-decoration: none">
                                             <div class="d-grid gap-2 pt-2">
                                                 <button type="submit" id="btn-save" value="addNewCategoryPublication" class="btn btn-primary btn-new">Guardar</button>
                                             </div>
                                         </a>
                                     </div>
                                 </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#datatable-ajax-crud').DataTable({
                                processing: true,
                serverSide: true,
                ajax: "{{ url('category-publication') }}",
                columns: [
                    {data: 'id', name: 'id', 'visible': false},
                    { data: 'name_category_publication', name: 'name_category_publication' },
            ...
            $('body').on('click', '.edit', function (e) {
                ...
                $.ajax({
                    type:"POST",
                    url: "{{ url('edit-category-publication') }}",
                    data: { id: id },
                    dataType: 'json',
            ...
            $('body').on('click', '.delete', function (e) {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    confirmButtonText: 'Si, borrar categoría de publicacion!',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type:"POST",
                            url: "{{ url('delete-category-publication') }}",
                            data: { id: id },
                            dataType: 'json',
                            success: function(res){
            ...
            $('body').on('click', '#btn-save', function (e) {
                e.preventDefault();
                var id = $("#id").val();
                var name_category_publication = $("#name_category_publicationID").val();
                ...
                $.ajax({
                    type:"POST",
                    url: "{{ url('add-update-category-publication') }}",
                    data: {
                        id:id,
                        name_category_publication:name_category_publication,
                    },
                    dataType: 'json',
