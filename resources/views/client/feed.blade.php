...
<div class="container ps-5 pe-5 ">
    <div class="row row-cols-1 g-4 d-flex justify-content-center">
        <div class="col col-md-8">
            <div class="card">
                <div class="row mt-2 mb-2 d-flex align-items-center flex-sm-column flex-xs-column flex-md-column flex-lg-row flex-xl-row flex-xxl-row">
                    <div class="col-lg-2 d-flex align-items-center justify-content-center">
                        <div class="row flex-column d-flex justify-content-center">
                            <div class="col-12 d-flex align-items-center justify-content-center">
                                @if(Auth::user()->avatar!=null)
                                <img src="{{Auth::user()->avatar}}" width="50" height="50" class="img-responsive img-circle" alt="">
                                @else
                                <img src="{{asset('images/admin.svg')}}" width="50" height="50" class="img-responsive img-circle" alt="">
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-10 d-flex align-items-center justify-content-center justify-content-lg-start justify-content-xl-start justify-content-xxl-start justify-content-md-center justify-content-sm-center justify-content-xs-center">
                        <button id="addNewPublication" class="btn btn-primary btn-new m-2" type="button">¿Deseas realizar una publicación?</button>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="d-flex justify-content-end col-2">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                  <a href="#">Editar <i class="dropbtn fa-solid fa-trash-can fa-1x"></i></a>
                                  <a href="#">Eliminar <i class="dropbtn fa-solid fa-pen-to-square fa-1x"></i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-grid gap-2 ps-4 pe-4 mt-2">
                    <form method="POST" action="javascript:void(0)" id="addEditPublicationForm" name="addEditPublicationForm">
                        @csrf
                        <input type="hidden" name="id" id="id">
                        <input type="hidden" name="user_id" id="user_id" value="{{Auth::user()->id}}">
                        <div class="mb-3">
                            <input id="title_PublicationID" type="text" class="form-control" name="title_publication" value="" required autocomplete="title_publication" autofocus placeholder="Título de la Publicación">
                            <span style="display: none;" class="invalid-feedback" id="title_publication_error_span" role="alert">
                                <strong id="title_publication_error"></strong>
                            </span>
                        </div>
                        <div class="mb-3">
                            <input id="text_PublicationID" type="text" class="form-control" name="text_publication" value="" required autocomplete="text_publication" autofocus placeholder="Descripción de la Publicación">
                            <span style="display: none;" class="invalid-feedback" id="text_publication_error_span" role="alert">
                                <strong id="text_publication_error"></strong>
                            </span>
                        </div>
                        <div class="mb-3 flex-column">
                            <label for="state" class="col-12 col-form-label text-md-start">{{ __('Categoría') }}</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="init_date_publicationID" type="date" class="form-control" name="init_date_publication" value="" required autocomplete="init_date_publication" autofocus>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="end_date_publicationID" type="date" class="form-control" name="end_date_publication" value="" required autocomplete="end_date_publication" autofocus>
                        ...
                        <div class="mb-3">
                            <label for="title" class="col-12 col-form-label text-md-start">{{ __('Imagen Adjunta') }}</label>
                            <input class="form-control form-control-sm" id="titleFileSm" name="file_publication" type="file" accept="image/,.jpg,.jpeg,.png,.gif" value="null">
                        </div>
                                ...
                                <div class="d-grid gap-2 m-2">
                                    <a href="" style="text-decoration: none">
                                        <div class="d-grid gap-2 pt-2">
                                            <button type="submit" id="btn-save" value="addNewAcademicLevel" class="btn btn-primary btn-new">Guardar</button>
                                        </div>
                                    </a>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit', function(e) {
            ...
            $.ajax({
                ...
                , success: function(res) {
                    ...
                    $('#inputCategory option[data-id="' + res.category_publication_id + '"]').attr('selected', 'selected');
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        , dataType: 'json'
                        , success: function(res) {
                            //TODO: llamar la lista de publicaciones
                            Toast.fire({
                                icon: 'success'
        ...
        $('#addEditPublicationForm').submit(function(e) {
            ...
            formData.append('category_publication_id', $('#inputCategory option:selected').attr('data-id'));
            $.ajax({
                type: 'POST'
                ...
                , success: (response) => {
                    ...
                    //TODO: actualizar la lista de publicaciones
                    if (response) {
                        Toast.fire({
                            icon: 'success'
